...
\begin{figure*}
  \begin{center}
    \input{graphics/model_www2016}
  \end{center}
  \caption{The alignment-inference model. A chain of normal distributions generates a linear predictor, which is converted into a probability for binomial draws of marker presence/absence.}\label{fig:model}
\end{figure*}
